...
import com.example.marqueetext.R;
...
public class MarqueeRecyclerView extends ConstraintLayout {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        // TODO: 8/15/2024 no background
        //addView(marqueeBackground);
        ...
        // TODO: 8/15/2024 invisible left logo
        //add Logo
        ...
        logoIV.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.app_icon_new));
        ...
        if (attrs != null && defStyleAttr == -1 && defStyleRes == -1) {
            ...
            //logo src [Drawable]
            logoIV.setImageResource(typedArray.getResourceId(R.styleable.MarqueeRecyclerView_logo_src, R.drawable.ic_launcher_foreground));
            boolean showLogo = typedArray.getBoolean(R.styleable.MarqueeRecyclerView_show_logo, false);
            if (!showLogo)
